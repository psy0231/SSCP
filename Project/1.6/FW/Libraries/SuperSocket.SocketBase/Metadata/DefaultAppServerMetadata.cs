...
namespace SuperSocket.SocketBase.Metadata
{
    ...
    /// </summary>
    [StatusInfo(StatusInfoKeys.StartTime, Name = "Started Time", DataType = typeof(DateTime), Order = 0)]
    ...
    [StatusInfo(StatusInfoKeys.RequestHandlingSpeed, Name = "Request Handling Speed (#/second)", Format = "{0:0f}", DataType = typeof(double), Order = 500)]
    [StatusInfo(StatusInfoKeys.Listeners, Name = "Listeners", DataType = typeof(string), OutputInperfLog = false, Order = 600)]
    [StatusInfo(StatusInfoKeys.AvailableSendingQueueItems, Name = "Available Sending Queue Items", DataType = typeof(int), Format = "{0:N0}", Order = 700)]
