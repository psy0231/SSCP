...
namespace SuperSocket.SocketBase.Provider
{
    ...
    public class ProviderKey
    {
        ...
        /// Gets the service.
        /// </summary>
        public static ProviderKey ServerType
        {
            get;
            private set;
        }
        ...
        /// </summary>
        public static ProviderKey SocketServerFactory
        {
            get;
            private set;
        }
        ...
        /// </summary>
        public static ProviderKey ConnectionFilter
        {
            get;
            private set;
        }
        ...
        /// </summary>
        public static ProviderKey LogFactory
        {
            get;
            private set;
        }
        ...
        /// </summary>
        public static ProviderKey ReceiveFilterFactory
        {
            get;
            private set;
        }
        ...
        /// </summary>
        public static ProviderKey CommandLoader
        {
            get;
            private set;
        }
