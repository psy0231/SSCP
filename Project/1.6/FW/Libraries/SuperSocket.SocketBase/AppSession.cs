...
namespace SuperSocket.SocketBase
{
        ...
        where TRequestInfo : class, IRequestInfo
    {
        ...
        public SslProtocols SecureProtocol
        {
            get
            {
                return SocketSession.SecureProtocol;
            }
            set
            {
                SocketSession.SecureProtocol = value;
            }
        }
        ...
        public IPEndPoint LocalEndPoint
        {
            get
            {
                return SocketSession.LocalEndPoint;
            }
        }
        ...
        /// </summary>
        public ISocketSession SocketSession
        {
            get;
            private set;
        }
        ...
        internal void InternalHandleException(Exception e)
        {
            HandleException(e);
        }
