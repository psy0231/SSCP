...
namespace SuperSocket.SocketBase.Config
{
    ...
    public interface IConfigurationSource : IRootConfig
    {
        ...
        /// </summary>
        IEnumerable<IServerConfig> Servers
        {
            get;
        }
        ...
        /// </summary>
        IEnumerable<ITypeProvider> ServerTypes
        {
            get;
        }
        ...
        /// </summary>
        IEnumerable<ITypeProvider> ConnectionFilters
        {
            get;
        }
        ...
        /// </summary>
        IEnumerable<ITypeProvider> LogFactories
        {
            get;
        }
        ...
        /// </summary>
        IEnumerable<ITypeProvider> ReceiveFilterFactories
        {
            get;
        }
        ...
        /// </summary>
        IEnumerable<ITypeProvider> CommandLoaders
        {
            get;
        }
    }
