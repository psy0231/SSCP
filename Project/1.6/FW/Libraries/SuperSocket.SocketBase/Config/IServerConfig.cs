...
namespace SuperSocket.SocketBase.Config
{
    ...
    public partial interface IServerConfig
    {
        ...
        /// </summary>
        NameValueCollection OptionElements
        {
            get;
        }
        ...
        ICertificateConfig Certificate
        {
            get;
        }
        ...
        /// </summary>
        IEnumerable<IListenerConfig> Listeners
        {
            get;
        }
        ...
        /// </value>
        IEnumerable<ICommandAssemblyConfig> CommandAssemblies
        {
            get;
        }
    }
